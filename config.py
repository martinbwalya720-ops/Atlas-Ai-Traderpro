...
DERIV_APP_ID = os.environ.get("DERIV_APP_ID", "")  # must be YOUR OWN registered app ID - no shared default under the new API
DERIV_WS_URL = "wss://ws.derivws.com/websockets/v3?app_id={app_id}"  # legacy endpoint - still used for public market data (synthetics)
DERIV_REST_BASE = "https://api.derivws.com"  # new API - used for account discovery + OTP handshake before trading
