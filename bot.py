...
async def _approve_trade(update: Update, context: ContextTypes.DEFAULT_TYPE, trade_id: str):
    ...
    if result["success"]:
        text = (
            ...
            f"Instrument: *{trade['display']}*\n"
            f"Direction: *{trade['direction']}*\n"
            f"Contract ID: `{result['contract_id']}`\n"
            f"Buy Price: `{result['buy_price']}`\n\n"
    ...
    await update.effective_message.reply_text(text, parse_mode=ParseMode.MARKDOWN, reply_markup=kb.main_menu())
